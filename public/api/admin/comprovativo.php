<?php
/**
 * V-MILLION — API: download do comprovativo de pagamento (vista do admin).
...
$pdo = kg_db();
$stmt = $pdo->prepare("SELECT comprovativo_path, comprovativo_tipo FROM pagamentos_condutores WHERE id = ?");
$stmt->execute([$id]);
